...
class ChatterDiscussionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($post->id) {
            ...
            $chatter_alert = [
                ...
                'chatter_alert' => trans('chatter::alerts.discussion_submit_success'),
            ];
            ...
            $chatter_alert = [
                'chatter_alert_type' => 'danger',
                'chatter_alert' => trans('chatter::alerts.discussion_submit_fail'),
            ];
    ...
    public function show($category, $slug = null)
    {
        ...
        $posts = Models::post()->with('user')->where('chatter_discussion_id', '=', $discussion->id)->orderBy(
            'created_at',
            'ASC'
        )->paginate(10);
